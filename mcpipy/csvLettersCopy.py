...
and a color string and builds block letters based on the string.
...
Any other value will produce a WOOl block of the specified color.
...
printLetters(x,y,z,'east','hi, ilana!','green')
'''
